...
const Form = ({onSubmit,location}) => {
    ...
    const heightForm= location ==='login' ? '235.11px' : '390px'
  return (
    <div>
       <form onSubmit={submitForm} style={{height:heightForm}} className="form-container" noValidate>
            {location==='register' && (
                ...
                <i></i>
                <label id="label-1-error" className="label-text" htmlFor="">Name</label>
                ...
                <input autoComplete="name" className="input" required="required" type="text"/>
                <i></i>
                <label id="label-1-error" className="label-text" htmlFor="">Last Name</label>
                <span id="label-1-error" className="material-symbols-outlined">
                    error
                </span>
                <h5 className="text-error">Please check your data</h5>
                ...
                <div className="input-container">
                <input autoComplete="username" className="input" required="required" type="text"/>
                <i></i>
                <label id="label-1-error" className="label-text" htmlFor="">Username</label>
                <span id="label-1-error" className="material-symbols-outlined">
                    error
                </span>
                <h5 className="text-error">Please check your data</h5>
